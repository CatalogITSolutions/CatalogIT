	...
	public WebDriver getLocalDriver() {
		if (readprop.readValue("browser").equalsIgnoreCase("CHROME")) {
			System.setProperty("webdriver.chrome.driver",
				"C:\\Java\\Selenium\\Irctc.co.in\\browser\\chromedriver\\chromedriver.exe");
			driver = new ChromeDriver();
		} else if (readprop.readValue("browser").equalsIgnoreCase("FIREFOX")) {
			System.setProperty("webdriver.gecko.driver",
					"C:\\Java\\Selenium\\Irctc.co.in\\browser\\geckodriver\\geckodriver.exe");
			driver = new FirefoxDriver();
		} else if (readprop.readValue("browser").equalsIgnoreCase("INTERNETEXPLORER")) {
			System.setProperty("webdriver.ie.driver",
					"C:\\Java\\Selenium\\Irctc.co.in\\browser\\IEDriverServer\\IEDriverServer.exe");
